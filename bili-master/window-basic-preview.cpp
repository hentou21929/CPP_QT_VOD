...
// {
//     MainWindow *main = reinterpret_cast<MainWindow *>(App::getInstance().getMainWindow());
...
//     float scale = main->previewScale / 1.0;//main->GetDevicePixelRatio();
// 	vec2 scaled_pos = pos;
...
//     MainWindow *main = reinterpret_cast<MainWindow *>(App::getInstance().getMainWindow());
//     float pixelRatio = 1.0;//main->GetDevicePixelRatio();
//     float x = pos.x() - 0;//main->previewX / pixelRatio;
//     float y = pos.y() - 0;//main->previewY / pixelRatio;
